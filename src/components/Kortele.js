...
import SocMyg from './SocMyg'
	...
	{
		id:0,
		tekstas:"How wonderful it is that nobody need wait a single moment before starting to improve the world.",
		autorius:"Anne Fran",
		color: '#73a857'
	},
	{
		id:1,
		tekstas:"Either write something worth reading or do something worth writing.",
